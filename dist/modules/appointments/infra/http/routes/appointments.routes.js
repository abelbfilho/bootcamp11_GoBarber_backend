...
var _unsureAuthenticated = _interopRequireDefault(require("../../../../users/infra/http/middlewares/unsureAuthenticated"));
...
appointmentsRouter.use(_unsureAuthenticated.default);
