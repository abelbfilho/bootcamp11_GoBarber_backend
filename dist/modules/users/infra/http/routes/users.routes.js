...
var _unsureAuthenticated = _interopRequireDefault(require("../middlewares/unsureAuthenticated"));
...
usersRouter.patch('/avatar', _unsureAuthenticated.default, upload.single('avatar'), userAvatarController.update);
